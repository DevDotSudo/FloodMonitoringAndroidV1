...
class WaterLevelGraph extends StatelessWidget {
  ...
  final WaterLevelDataController waterLevelDataController;

  const WaterLevelGraph({super.key, required this.dataPoints, required this.waterLevelDataController});
