          ...
          children: [
            Expanded(
              child: _buildMetricCard(
                ...
                value: '$status - ${(currentLevel - 8).toInt().toString()}',
            ...
            Expanded(
              child: _buildMetricCard(
                ...
                value: currentLevel.toStringAsFixed(2) == "8.00" ? '<= ${currentLevel.toStringAsFixed(2)} ft' : '${currentLevel.toStringAsFixed(2)} ft',
